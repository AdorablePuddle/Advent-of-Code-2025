...
int main(){
    ...
    do {
            ...
            for (int c = 0; c < max_width; c++) {
                ...
                if (paper_map[r][c] == '@') {
                    ...
                    for (int d = 0; d < 8; d++) {
                        ...
                        toilet_paper_counter += (paper_map[nr][nc] == '@' || paper_map[nr][nc] == 'X');
                    }

                    if (toilet_paper_counter < 4) {
                        paper_map[r][c] = 'X'; // Marked for removal
        ...
        for (int r = 0; r < max_height; r++) {
            for (int c = 0; c < max_width; c++) {
                // If it is marked for removal, delete it.
                if (paper_map[r][c] == 'X') {
                    paper_map[r][c] = '.';
                }
            }
        }
        result += removed_this_iteration;
